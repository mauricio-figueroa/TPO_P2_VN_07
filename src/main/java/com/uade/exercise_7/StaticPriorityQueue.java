...
public class StaticPriorityQueue implements PriorityQueue {
    ...
    public void updatePriority(int oldPriority, int newPriority) {
        if (isEmpty()) {
            throw new RuntimeException("No se puede actualizar la prioridad en una cola vacía");
        }
        for (int i = 0; i < count; i++) {
            if (priorities[i] == oldPriority) {
    ...
    private void adjustPriorities(int startIndex) {
